...
- https://vial-staging.calltheshots.us/api/export-mapbox-preview
- https://vial-staging.calltheshots.us/api/export-mapbox-preview?id=recgP5RSXunz1yrwm
